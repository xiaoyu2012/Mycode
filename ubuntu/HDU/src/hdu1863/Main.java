...
public class Main {
	...
	public static void main(String[] args) {
		...
		while ((N = in.nextInt()) != 0) {
			...
			/*
			 * // Output weight for(int[] x : weight) { for(int y : x)
			...
			/* for(tree x : s) System.out.println(x.vertics + " " + x.weight);
			
			 System.out.println(s.get(N - 1).vertics + "\n");*/
			
			if (s.get(N - 1).vertics == 1)
				System.out.println("?");
			else
